...
vignette: >
  %\VignetteIndexEntry{Shiny-input help links}
...
For links (activated by clicking), embed a `shiny::icon("info-circle")` which is the default for `shiny_iconlink()`. For elements activated by hovering, embed a `shiny::icon("info")`.
